...
export function SplitTypeField() {
  ...
  const equalAmount = selectedParticipantCount > 0 && totalAmount > 0 
              ...
              <div>
                ...
                >
                  <Scale
                    className={cn(
                      "h-6 w-6",
                      field.value === "equal" ? "text-emerald-600 dark:text-emerald-400" : "text-muted-foreground"
                    )}
                  />
                  <span className={cn(
                    "text-sm font-bold",
                    field.value === "equal" ? "text-emerald-700 dark:text-emerald-400" : "text-muted-foreground"
                  )}>
                    {t('bills.splitEqual')}
                  </span>
                  {selectedParticipantCount > 0 && totalAmount > 0 && field.value === "equal" && (
              ...
              <div>
                ...
                >
                  <TrendingUp
                    className={cn(
                      "h-6 w-6",
                      field.value === "custom" ? "text-emerald-600 dark:text-emerald-400" : "text-muted-foreground"
                    )}
                  />
                  <span className={cn(
                    "text-sm font-bold",
                    field.value === "custom" ? "text-emerald-700 dark:text-emerald-400" : "text-muted-foreground"
                  )}>
                    {t('bills.splitCustom')}
                  </span>
                </Label>
