              ...
              return (
                ...
                >
                  <span className="flex items-center gap-1.5">
                    <User className={cn("h-3 w-3", isSelf ? "text-emerald-700 dark:text-emerald-400" : "opacity-50")} />
                  ...
                  <span className={cn("font-mono", isSelf ? "opacity-100" : "opacity-80")}>
      ...
      <div className="flex justify-between items-start mb-2">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            ...
            {isSelfPayer && (
              <span className="ml-1 text-emerald-600 dark:text-emerald-400">({t('bills.you')})</span>
            )}
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Badge variant="outline" className="text-amber-600 dark:text-amber-400 h-5 text-[10px] border-amber-200 dark:border-amber-500/30">
            {t('bills.used')}
          </Badge>
        </div>
      </div>
